                ...
                <div class="row m-0">
                    ...
                    <div class="col-sm-7 authfy-panel-right">
                        <div class="authfy-login">
                            <h3>Login
                                <small class="d-block text-muted">Enter your email address and password to access the
                                    account</small>
                            </h3>
                            @if (session('success'))
                            ...
                            @endif
                            <form method="POST" action="{{ route('super_admin_login') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="inputPassword">
                                        <span class="d-flex nm-jcb nm-aic">
                                            Password
                                            <a class="nm-lu nm-ct" href="{{ route('admin.forgotPassword') }}">Forgot
                                                Password?</a>
                                        </span>
                                    </label>
