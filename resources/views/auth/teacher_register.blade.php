            ...
            <div class="col-sm-10 offset-sm-1">
                <div class="sign-in-box">
                    <a href="{{ route('land_page') }}"><i title="Home Page"
                            class="fa fa-home text-primary fa-2x float-right mr-2"></i></a>
                        ...
                        <div class="col-lg-7 form-div wow fadeInRight">
                            ...
                            <form class="cd-form" method="POST" action="{{ route('teacher_register') }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label for="image">Upload Profile Picture<span class="text-danger">*</span></label>
                                ...
                                <div class="form-row mt-2">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <a href="{{ route('teacher_login') }}" class="btn btn-create mt-2" type="button"
