...
<head>
    ...
    <title>Leading Lights - Hr Profile </title>
    <meta name="viewport"
           ...
           <!--      <div class="app-header__logo">
                ...
                <div class="app-main__inner">
                    ...
                    <div class="bg-edit2 p-4"> 
                     <div class="row">
                        <div class="col-lg-5">
                             <img src="assets/images/avata2.jpg" class="img-fluid mx-auto rounded">
                    </div>                       
                        <div class="col-lg-7 not2
                        ">
                             <p>Joined- 03.08.2020</p>
                             <h4 class="mb-4">Jesica Goams<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span></h4>
                               <div class="row">
                                            <div class="col-md-5">
                                                <label>Address:</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p>3/87 Hudson Street, USA</p>
                                            </div>
                                             <div class="col-md-1">
                            ...
                            <div class="card-shadow-primary profile-responsive card-border mb-3 card">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner">
                                            ...
                                            <img src="assets/images/pro1.png" class="img-fluid mx-auto d-block w-100">
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper justify-content-between">
                                                ...
                                                <div class="widget-content-left d-sm-flex align-items-center">
                                                    ...
                                                    <div class="widget-subheading pl-3">
                            ...
                            <div class="card-shadow-primary profile-responsive card-border mb-3 card">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner">
                                            ...
                                            <img src="assets/images/pro2.png" class="img-fluid mx-auto d-block w-100">
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="d-sm-flex align-items-center not">
                                                                ...
                                                                <div class="ml-3">
                                                                    <div class="widget-subheading">Proin gravida nibh vel velit auctor aliquet. sollicitudin, lorem quis bibendum auctor, nisi elit consequat</div>
