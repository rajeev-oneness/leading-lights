    ...
    <div class="app-sidebar sidebar-shadow">
        ...
        <div class="app-main__inner">
            ...
            <div class="bg-edit2 p-4"> 
             <div class="row">
                <div class="col-lg-5">
                     <img src="{{ asset($hr->image ? $hr->image :'frontend/assets/images/avata2.jpg') }}" class="img-fluid mx-auto rounded">
            </div>                       
                <div class="col-lg-7 not2
                ">
                     <p>Joined- {{ $hr->doj ? $hr->doj : 'N/A' }}</p>
                     <h4 class="mb-4">{{ $hr->first_name ? $hr->first_name : 'N/A' }}  {{ $hr->last_name ? $hr->last_name : 'N/A' }}
