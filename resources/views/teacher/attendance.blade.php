                                    ...
                                    <table class="table table-hover bg-table" id="attendance_table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-tr">
                                                ...
                                                <td>{{ $attendance->logout_time ? $attendance->logout_time : 'N/A' }}</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td>{{ isset($date) ? $date : 'N/A'}}</td>
                                                <td>{{ isset($login_time) ? $login_time : 'N/A' }}</td>
                                                <td>{{ isset($logout_time) ? $logout_time : 'N/A'}}</td>
                                                <td>
                                                    <span class="mr-2"><i
