							...
							<div class="row m-0 pt-3">
								...
								<div class="col-lg-6">
									<div class="form-group edit-box">
										...
										<input type="file" name="video" class="form-control" id="video" value="{{ $video->video }}">
										@if ($errors->has('video'))
								...
								<div class="col-lg-6">
									<div class="form-group edit-box">
										...
										<select class="form-control" name="video_type">
											<option value="1" @if($video->status == 1) selected @endif>Paid</option>
											<option value="0" @if($video->status == 0) selected @endif>Free</option>
										</select>
									</div>
								</div>
								<div class="col-lg-6">
