            ...
            <div class="row m-0 dashboard-content-header">
                <div class="col-lg-6 d-flex">
                    ...
                    <ul class="breadcrumb p-0">
                        ...
                        <li class="text-white"><i class="fa fa-chevron-right"></i></li>
                        <li><a href="{{ route('admin.teachers.edit', $teacher->id) }}" class="active">Edit
                                teacher</a></li>
                    </ul>
                </div>
                ...
                <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST"
                    ...
                    <div class="row m-0 pt-3">
                        <div class="col-lg-6">
                            <div class="form-group edit-box">
                                ...
                                <input type="text" name="first_name" class="form-control" id="first_name"
                                    value="{{ $teacher->first_name }}" onkeydown="return alphaOnly(event);">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group edit-box">
                                ...
                                <input type="text" name="last_name" class="form-control" id="last_name"
                                    value="{{ $teacher->last_name }}" onkeydown="return alphaOnly(event);">
                        ...
                        <div class="col-lg-6 form-group edit-box">
                            ...
                            <input type="text" id="mobile" class="form-control" value="{{ $teacher->mobile }}"
                                name="mobile" maxlength="10"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                @if ($teacher->mobile == '') onkeyup="mobileValidation()" @endif>
