...
<div class="dashboard-body" id="content">
				...
				<div class="dashboard-body-content">
						<h5>Edit Page</h5>
						<hr>
						<form action="{{ route('admin.banner.update',$page_details->id) }}" method="POST" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row m-0 pt-3">
								<div class="col-lg-12">
									<div class="form-group edit-box">
										...
										<input type="text" name="name" class="form-control" id="name" value="{{ $page_details->name }}">
										@if ($errors->has('name'))
