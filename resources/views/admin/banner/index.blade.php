			...
			<table class="table table-sm table-hover" id="teacher_table">
				...
				<tbody>
					...
					<tr>
						...
						<td>
                            <a href="{{ route('admin.banner.show',$page->id) }}"><i class="far fa-eye"></i></a>
                            <a href="{{ route('admin.banner.edit',$page->id) }}" class="ml-2"><i class="far fa-edit"></i></a>
                            ...
                            <form id="delete_form_{{ $page->id }}" action="{{ route('admin.banner.destroy',$page->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            </form></td>
                        </td>
