...
<div class="dashboard-body" id="content">
				...
				<div class="dashboard-body-content">
						<h5>Edit Class</h5>
						<hr>
						<form action="{{ route('admin.classes.update',$class_details->id) }}" method="POST" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row m-0 pt-3">
								<div class="col-lg-12">
									<div class="form-group edit-box">
										...
										<input type="text" name="name" class="form-control" id="name" value="{{ $class_details->name }}">
										@if ($errors->has('name'))
