<div class="dashboard-menubar" id="sidebar">
    ...
    <nav class="">
        <ul class=" menu">
            ...
            <li class="{{ Request::is('admin/vlog*') ? 'active' : '' }}">
            ...
            <li class="{{ Request::is('admin/special-courses*') ? 'active' : '' }}">
            ...
            <li><a href="{{ route('admin.report.index') }}"><i class="fa fa-file" aria-hidden="true"></i>Report
                    Generation</a></li>
            ...
            <li class="{{ Request::is('admin/banner*') ? 'active' : '' }}" id="banner">
