...
<ul class=" menu">
        ...
        <li class="{{ Request::is('admin/teachers*') ? 'active' : '' }}"><a
                href="{{ route('admin.teachers.index') }}"><i class="fa fa-user" aria-hidden="true"></i>Teacher
                Management</a></li>
        <li class="{{ Request::is('admin/transaction*') ? 'active' : '' }}"><a
                href="{{ route('admin.transaction.index') }}"><i class="fas fa-wallet"></i>Transaction Management</a>
        </li>
        <li class="{{ Request::is('admin/vlog*') ? 'active' : '' }}"><a href="{{ route('admin.vlog.index') }}"><i
                    class="fa fa-video-camera" aria-hidden="true"></i>VLOG Management</a></li>
        ...
        <li class="{{ Request::is('admin/special-courses*') ? 'active' : '' }}"><a
                href="{{ route('admin.special-courses.index') }}"><i class="fas fa-book-open"></i>Course Management</a>
        </li>
        ...
        <li class="{{ Request::is('admin/holidays*') ? 'active' : '' }}"><a
                href="{{ route('admin.holidays.index') }}"><i class="fas fa-snowman"></i></i>Managing Holidays</a>
        </li>
        <li class="{{ Request::is('admin/notification*') ? 'active' : '' }}"><a
                href="{{ route('admin.notification.index') }}"><i class="fas fa-bell"></i></i>Managing
                Notification</a></li>
        <li class="{{ Request::is('admin/cms*') ? 'active' : '' }}"><a href="{{ route('admin.cms.index') }}"><i
                    class="fas fa-file-alt"></i></i>Managing CMS pages/content</a></li>
        <li class="{{ Request::is('admin/banner*') ? 'active' : '' }}"><a
                href="{{ route('admin.banner.index') }}"><i class="fas fa-file-alt"></i>Banner management</a></li>
