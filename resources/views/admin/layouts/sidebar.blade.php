<div class="dashboard-menubar" id="sidebar">
    ...
    <nav class="">
        <ul class=" menu">
            ...
            <li
                class="{{ Request::is('super-admin/admin*') ? 'active' : '' }}">
                <a href="{{ route('superAdmin.admin.index') }}"><i class="fa  fa-user-cog"
            ...
            <li
                ...
                <a href="{{ route('admin.teachers.index') }}"><i class="fa fa-user"
                        aria-hidden="true"></i>Teacher
                    Management</a></li>
            <li
                class="{{ Request::is('admin/hr*') ? 'active' : '' }}">
                <a href="{{ route('admin.hr.index') }}"><i class="fas fa-user-tie"></i></i>HR
                    Management</a></li>
            <li
                class="{{ Request::is('admin/transaction*') ? 'active' : '' }}">
                <a href="{{ route('admin.transaction.index') }}"><i
                        class="fas fa-wallet"></i>Transaction
                    Management</a>
            </li>
            <li
                class="{{ Request::is('admin/vlog*') ? 'active' : '' }}">
            ...
            <li
                ...
                <a href="{{ route('admin.classes.index') }}"><i
                        class="fas fa-chalkboard-teacher"></i>Regular Class
                    Management</a></li>
            <li
                class="{{ Request::is('admin/special-courses*') ? 'active' : '' }}">
                <a href="{{ route('admin.special-courses.index') }}"><i
                        class="fas fa-book-reader"></i>Special Course
                    Management</a>
            </li>
            <li
            ...
            <li
                class="{{ Request::is('admin/subjects*') ? 'active' : '' }}">
                <a href="{{ route('admin.subjects.index') }}"><i class="fas fa-book-open"></i>Student
                    Subject
                    Management</a></li>
            <li
                class="{{ Request::is('admin/groups*') ? 'active' : '' }}">
                <a href="{{ route('admin.groups.index') }}"><i class="fas fa-users"></i>Student Group
                    Management</a></li>
            <li
                class="{{ Request::is('admin/qualification*') ? 'active' : '' }}">
                <a href="{{ route('admin.qualifications.index') }}"><i
                        class="fas fa-chalkboard"></i>Academic
                    Qualification
                    Management</a></li>
            <li
                class="{{ Request::is('admin/arrange-classes*') ? 'active' : '' }}">
                <a href="{{ route('admin.arrange_classes') }}"><i
                        class="fas fa-chalkboard"></i>Arrange Class
                    Management</a></li>
            <li
            ...
            <li
                ...
                <a href="{{ route('admin.holidays.index') }}"><i
                        class="fas fa-snowman"></i></i>Managing
                    Holidays</a>
            </li>

            <li
                class="{{ Request::is('admin/notification*') ? 'active' : '' }}">
                <a href="{{ route('admin.notification.index') }}"><i
                        class="fas fa-bell"></i></i>Managing
                    Notification</a></li>
            <li
