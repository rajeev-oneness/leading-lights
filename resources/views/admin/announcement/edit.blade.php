...
<div class="dashboard-body" id="content">
				...
				<div class="dashboard-body-content">
						...
						<hr>
						<form action="{{ route('admin.announcement.update',$announcement_details->id) }}" method="POST" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row m-0 pt-3">
								<div class="col-lg-6">
									<div class="form-group edit-box">
										...
										<input type="text" name="title" class="form-control" id="title" value="{{ $announcement_details->title }}">
										@if ($errors->has('title'))
								...
								<div class="col-lg-6">
									...
									<input type="date" id="date" class="form-control" name="date" value="{{ $announcement_details->date }}">
									@if ($errors->has('date'))
