                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-tr">
                                        ...
                                        <td>
                                            ...
                                            <button class="btn-pill btn-transition btn btn-danger"><i class="fa fa-dot-circle">
                                                Expired</i></button>
                                            @elseif ($available_class->date == $today_date && ($today_time >=
                                                $available_class->start_time && $today_time <= $new_time)) 
                                                ...
                                                @endif
                                            @elseif ($available_class->date == $today_date && $today_time <=
                                            $available_class->start_time)
                                            <button class="btn-pill btn-transition btn btn-success"><i class="fa fa-dot-circle">
                                                    Upcoming</i></button>
                                            @else
                                            <button class="btn-pill btn-transition btn btn-danger"><i class="fa fa-dot-circle">
                                                Expired</i></button>
